        ...
        <Container maxW="container.md" pb="90px">
          <Box py={['23px', '23px', '35px']} color="gray.200">
            ...
            <Text fontSize={['14px', '14px', '16px']}>
              ...
              which we hope you are going to love to see how Art of Peace, Mutual Assured Regeneration and in general, ways to start observing an enduring, civic  world peace via arts and tech, on blockchain..
            </Text>
          </Box>
